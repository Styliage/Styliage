...
初始概率 = {'星5精选':0.03, '星5':0.03, '星4':0.58, '星3':0.36}
# 初始概率 = {'星5精选':0.08, '星5':0, '星4':0.57, '星3':0.35}
...
while 宝珠数量 >= 5:
    ...
    if 出货 or 歪:
        叠加概率角色数量 = 0
    概率_星5精选 = 初始概率['星5精选'] + (int(叠加概率角色数量 / 5) * 0.005 / (初始概率['星5精选'] + 初始概率['星5']) * 初始概率['星5精选'])
    概率_星5 = 初始概率['星5'] + (int(叠加概率角色数量 / 5) * 0.005 / (初始概率['星5精选'] + 初始概率['星5']) * 初始概率['星5'])
    概率_星4 = 初始概率['星4'] - (int(叠加概率角色数量 / 5) * 0.005 / (初始概率['星4'] + 初始概率['星3']) * 初始概率['星4'])
    概率_星3 = 初始概率['星3'] - (int(叠加概率角色数量 / 5) * 0.005 / (初始概率['星4'] + 初始概率['星3']) * 初始概率['星3'])
